...
export const EMPTY = {
  ...
  students: {
    icon: 'students',
    title: 'No student records have been added yet',
    message: 'Students are created automatically when you import a test report, or you can add one manually.',
  },
  studentsFiltered: {
    icon: 'search',
  ...
  studentSessions: {
    icon: 'sessions',
    title: 'No test sessions for this student',
    message: 'Sessions appear here once a report captured by this student is imported.',
  },
  bugs: {
    icon: 'bugs',
    tone: 'ok',
  ...
  projectStudents: {
    ...
    message: 'Importing a report links its student to this application automatically.',
  },
};
